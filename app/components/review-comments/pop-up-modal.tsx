  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <View
          style={[styles.modalView, { backgroundColor: theme.quinaryText }]}
        >
              ...
              return (
                ...
                >
                  <AntDesign
                    ...
                    color={isFilled ? theme.starColor : "gray"}
                    size={20}
                  />
                </TouchableOpacity>
              );
          ...
          <View style={styles.buttonContainer}>
            <Pressable
              ...
              style={[
                styles.button,
                {
                  backgroundColor: selectedStars === 0 ? "gray" : theme.primary,
                },
              ]}
            >
              <View style={styles.center}>
                <NunitoText
                  style={[styles.buttonText, { color: theme.quinaryText }]}
                >
                  Avaliar
                </NunitoText>
              </View>
