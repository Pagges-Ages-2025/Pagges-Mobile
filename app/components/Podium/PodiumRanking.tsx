  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => onUserPress?.(secondRank.username)}
      >
        <View style={styles.secondContainer}>
          <Image
            style={styles.imageCircle}
            source={secondRank.image ? { uri: secondRank.image } : defaultImage}
            resizeMode="cover"
          />
      ...
      <TouchableOpacity
        disabled={!pressEnabled}
        onPress={() => onUserPress?.(firstRank.username)}
      >
        <View style={styles.firstContainer}>
          <View>
            <Image
              style={styles.imageCircle}
              source={firstRank.image ? { uri: firstRank.image } : defaultImage}
              resizeMode="cover"
            />
            <Image
              style={styles.crown}
      ...
      <TouchableOpacity
        disabled={!pressEnabled}
        onPress={() => onUserPress?.(thirdRank.username)}
      >
        <View style={styles.thirdContainer}>
          <Image
            style={styles.imageCircle}
            source={thirdRank.image ? { uri: thirdRank.image } : defaultImage}
            resizeMode="cover"
          />
          <View style={styles.personName}>
            <NunitoText
